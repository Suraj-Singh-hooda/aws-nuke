...
`$ wget -c https://github.com/rebuy-de/aws-nuke/releases/download/v2.25.6/aws-nuke-v2.25.6-linux-amd64.tar.gz -O - | tar -xz -C $HOME/bin`

Run
`$ aws-nuke-v2.25.6-linux-amd64`
...
$ docker run \
    ...
    quay.io/rebuy/aws-nuke:v2.25.6 \
    --profile default \
